...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=CowymTgI#fMCt6QyN5VdHjozxPJNIC_NWQvwxSMcNznObnl-Y9vI' : process.env.SESSION_ID,
...
PREMIUM_USERS: process.env.PREMIUM_USERS || '923705351150',    
